...
- 首页（Banner + 四服务 2×2 网格 + 人工下单/AI 智能下单双入口 + 热门医院入口卡（跳转特色 Tab），双入口位于四大核心业务下方）
- 服务二级目录（不展示价格）→ 流程步骤页（统一 3 阶段 7 步：服务前/服务中/服务后）→ 立即预约直达统一需求表单
- 特需服务新增"就诊预约"入口（直达表单并预选服务类型）
- 统一需求表单（人工下单与"我的需求"合并：患者档案可编辑、服务类型可选、AI 帮填与人工填写实时同步草稿、可后补身份证/检查报告）
- 订单查看（状态筛选 / 详情时间线 / 已接单与未接单状态 / 接单人电话一键拨打）
- 陪诊进度（含接单人信息）
- 个人中心（统计 / 就诊人管理 / 我的需求 / 我的评价）
- 特色 Tab：完整医院目录（搜索 / 分类 / 城市 / 服务量排序筛选 + 实景图卡）→ 医院详情（含核心优势与"立即预约陪诊"）
